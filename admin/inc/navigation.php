...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-light-primary elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>admin" class="brand-link bg-navy text-md">
        ...
        <span class="brand-text font-weight-bold text-light"><?php echo $_settings->info('short_name') ?> - Admin</span>
        </a>
        <!-- Sidebar -->
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-header font-weight-bold">Master List</li>
    ...
    $(document).ready(function(){
      ...
      $('.nav-link.active').addClass('bg-primary')
    })
  </script>